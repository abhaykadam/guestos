...
///	printf("\n Inside config_create\n");
	...
	{
///		printf("\n exitng config_create with error\n");
		return NULL;
	}
///	printf("\n Exitng config_create properly\n");
...
///	printf("\n Enterd inside config_load\n");
	...
	if (!f)
	{
///		printf("\n Trying to filename=%s\n",cfg->filename);
///		printf("\n In config_load could not open file\n");
		return 0;
	}	
	...
	/* close file */
	fclose(f);
///	printf("\n In config_load retirning normaly\n");
	return 1;
}
