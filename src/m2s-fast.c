...
int main(int argc, char **argv)
{
	...
	argc = 2;
	argv[0] = "myself";
	argv[1] = "/home/prajakta/praj_multi2sim_RandD/guestos_multi2sim/mytest/hello";
fprintf(stderr,"\n Welcome to guestos\n");
	/* Initial information */
...
///printf("\n before 4 ld_load");
	///ld_load_prog_from_cmdline(1, "/home/prajakta/Desktop/praj_multi2sim_RandD/guestos/mytest/hello");
